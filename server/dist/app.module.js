...
const hospital_module_1 = require("./models/hospital.module");
const doctor_module_1 = require("./models/doctor.module");
const appointment_module_1 = require("./models/appointment.module");
