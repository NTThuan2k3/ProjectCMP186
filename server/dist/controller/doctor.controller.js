...
let DoctorController = class DoctorController {
    ...
    async getCurrentDoctorId(req) {
        const doctor = req.user;
        console.log('Request doc:', doctor);
        return { userId: doctor.id };
    }
...
], DoctorController.prototype, "loadDoctors", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DoctorController.prototype, "filterDoctors", null);
__decorate([
    (0, common_1.Get)('id'),
    ...
    __metadata("design:returntype", Promise)
], DoctorController.prototype, "getCurrentDoctorId", null);
__decorate([
